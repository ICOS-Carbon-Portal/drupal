...
class PageWithCpEvents extends BlockBase {
	...
	function build() {
		...
		$list_of_elements['cp_events_more_news_url'] = $config['cp_events_more_news_url'];
	...
	public function blockForm($form, FormStateInterface $form_state) {
		...
		$form['cp_events_more_news_url'] = [
	    '#type' => 'textfield',
	    '#title' => $this->t('News archive URL'),
			'#default_value' => $config['cp_events_more_news_url']
	  ];
	...
	public function blockSubmit($form, FormStateInterface $form_state) {
		...
		$this->setConfigurationValue('cp_events_more_news_url', $form_state->getValue('cp_events_more_news_url'));
	}
}
